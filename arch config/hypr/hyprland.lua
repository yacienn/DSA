...
-- ================athir@Athir ~]\>sudo systemctl enable --now NetworkManager
...
hl.bind(
    "CTRL + P",
    hl.dsp.exec_cmd(
        "grim -g \"$(slurp)\" ~/pic/screenshot-$(date +%Y-%m-%d_%H-%M-%S).png"
    )
)
-- ============================================================
-- ALT + TAB
...
hl.window_rule({
    ...
    opacity = "0.73 override 0.995 override",
})
...
hl.bind(
    mainMod .. " + D",
    hl.dsp.exec_cmd("~/.config/hypr/scripts/show-desktop.sh")
)
